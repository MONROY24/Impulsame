  ...
  <div class="wrapper">
    <section class="chat-area">
      <header>
        ...
        $sql = mysqli_query($conexion, "SELECT * FROM perfil WHERE ID_Perfil = {$user_id}");
...
echo base64_encode($row['Foto']) ?>">
        <div class="details">
          <span><?php echo $row['Nombre1'] . " " . $row['Apellido1'] ?>  <?php echo $_SESSION['wid']; ?></span>
